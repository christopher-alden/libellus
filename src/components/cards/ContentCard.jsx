...
export default function ContentCard({ courses, category }) {
  ...
  return (
    <Link to={`/details/${category}/${courses.id}`}>
      <div className={`text-d-text bg-d-secondary w-36 h-64 rounded-md ${brColor} border-2 flex-col shadow-md mx-auto justify-between xl:w-80`}>
        ...
        <div className="relative text-d-text text-sm font-bold p-4 bottom-0">
          {courses.lessons}
