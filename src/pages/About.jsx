...
export default function About() {
  ...
  return (
    <div className={`w-screen h-[500px] ${bgColor} flex flex-col justify-center items-center text-d-text font-bold`}>
        <div className='text-6xl mb-6'>{course.title}</div>
        <div className='font-light text-xl text-center w-[1000px] line-clamp-2'>{course.description}</div>
    </div>
  );
}
